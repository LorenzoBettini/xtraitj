...
public class XtraitjSyntacticSequencer extends AbstractSyntacticSequencer {

	protected XtraitjGrammarAccess grammarAccess;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (XtraitjGrammarAccess) access;

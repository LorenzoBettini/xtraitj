...
'''
	...
	def private void assertTraitAdapterJavaInterface(CompilationTestHelper$Result r, String name, CharSequence expected) {
		r.assertTraitJavaInterface(name + "_Adapter", expected)
	}

	def private void assertTraitJavaInterface(CompilationTestHelper$Result r, String name, CharSequence expected) {
		r.assertJavaCode("traits." + name, expected)
	}

	def private void assertTraitAdapterJavaClass(CompilationTestHelper$Result r, String name, CharSequence expected) {
		r.assertTraitJavaClass(name + "_Adapter", expected)
	}

	def private void assertTraitJavaClass(CompilationTestHelper$Result r, String name, CharSequence expected) {
		r.assertJavaCode("traits.impl." + name + "Impl", expected)
	}

	def private void assertTraitAdapterJavaInterface(CompilationTestHelper$Result r, String packageName, String name, CharSequence expected) {
		r.assertTraitJavaInterface(packageName, name + "_Adapter", expected)
	}

	def private void assertTraitJavaInterface(CompilationTestHelper$Result r, String packageName, String name, CharSequence expected) {
		r.assertJavaCode(packageName + ".traits." + name, expected)
	}

	def private void assertTraitAdapterJavaClass(CompilationTestHelper$Result r, String packageName, String name, CharSequence expected) {
		r.assertTraitJavaClass(packageName, name + "_Adapter", expected)
	}

	def private void assertTraitJavaClass(CompilationTestHelper$Result r, String packageName, String name, CharSequence expected) {
		r.assertJavaCode(packageName + ".traits.impl." + name + "Impl", expected)
	}

	def private void assertJavaClass(CompilationTestHelper$Result r, String packageName, String name, CharSequence expected) {
		r.assertJavaCode(packageName + "." + name, expected)
	}

	def private void assertJavaClass(CompilationTestHelper$Result r, String name, CharSequence expected) {
		r.assertJavaCode(name, expected)
	}
	
	def private void assertJavaCode(CompilationTestHelper$Result r, String name, CharSequence expected) {
		r => [
			expected.toString.assertEquals(getGeneratedCode(name))
		]
	}

	def private executeGeneratedJavaClassMethodAndAssert(CompilationTestHelper$Result r, String className, String methodName, CharSequence expected) {
		r => [

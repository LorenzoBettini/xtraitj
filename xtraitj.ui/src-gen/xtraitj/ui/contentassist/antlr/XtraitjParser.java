...
* generated by Xtext
*/
package xtraitj.ui.contentassist.antlr;
...
public class XtraitjParser extends AbstractContentAssistParser {
	...
	@Override
	protected xtraitj.ui.contentassist.antlr.internal.InternalXtraitjParser createParser() {
		xtraitj.ui.contentassist.antlr.internal.InternalXtraitjParser result = new xtraitj.ui.contentassist.antlr.internal.InternalXtraitjParser(null);
	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				...
				{
					put(grammarAccess.getTJDeclarationAccess().getAlternatives(), "rule__TJDeclaration__Alternatives");
					put(grammarAccess.getTJTraitOperationAccess().getAlternatives(), "rule__TJTraitOperation__Alternatives");
					put(grammarAccess.getTjTraitOperationForProvidedAccess().getAlternatives(), "rule__TjTraitOperationForProvided__Alternatives");
					put(grammarAccess.getTJMemberAccess().getAlternatives(), "rule__TJMember__Alternatives");
					put(grammarAccess.getTJMethodDeclarationAccess().getAlternatives(), "rule__TJMethodDeclaration__Alternatives");
					...
					put(grammarAccess.getTJProgramAccess().getGroup(), "rule__TJProgram__Group__0");
					put(grammarAccess.getTJProgramAccess().getGroup_0(), "rule__TJProgram__Group_0__0");
					put(grammarAccess.getTJTraitAccess().getGroup(), "rule__TJTrait__Group__0");
					put(grammarAccess.getTJTraitAccess().getGroup_2(), "rule__TJTrait__Group_2__0");
					put(grammarAccess.getTJClassAccess().getGroup(), "rule__TJClass__Group__0");
					put(grammarAccess.getTJClassAccess().getGroup_2(), "rule__TJClass__Group_2__0");
					put(grammarAccess.getTJClassAccess().getGroup_2_2(), "rule__TJClass__Group_2_2__0");
					put(grammarAccess.getTJClassAccess().getGroup_3(), "rule__TJClass__Group_3__0");
					put(grammarAccess.getTJTraitExpressionAccess().getGroup(), "rule__TJTraitExpression__Group__0");
					put(grammarAccess.getTJTraitExpressionAccess().getGroup_1(), "rule__TJTraitExpression__Group_1__0");
					put(grammarAccess.getTJTraitReferenceAccess().getGroup(), "rule__TJTraitReference__Group__0");
					put(grammarAccess.getTJTraitReferenceAccess().getGroup_1(), "rule__TJTraitReference__Group_1__0");
					put(grammarAccess.getTJTraitReferenceAccess().getGroup_1_2(), "rule__TJTraitReference__Group_1_2__0");
					put(grammarAccess.getTJHideOperationAccess().getGroup(), "rule__TJHideOperation__Group__0");
					put(grammarAccess.getTJRestrictOperationAccess().getGroup(), "rule__TJRestrictOperation__Group__0");
					put(grammarAccess.getTJAliasOperationAccess().getGroup(), "rule__TJAliasOperation__Group__0");
					put(grammarAccess.getTJRenameOperationAccess().getGroup(), "rule__TJRenameOperation__Group__0");
					put(grammarAccess.getTJRedirectOperationAccess().getGroup(), "rule__TJRedirectOperation__Group__0");
					put(grammarAccess.getTJFieldAccess().getGroup(), "rule__TJField__Group__0");
					put(grammarAccess.getTJFieldAccess().getGroup_2(), "rule__TJField__Group_2__0");
					put(grammarAccess.getTJRequiredMethodAccess().getGroup(), "rule__TJRequiredMethod__Group__0");
					put(grammarAccess.getTJRequiredMethodAccess().getGroup_3(), "rule__TJRequiredMethod__Group_3__0");
					put(grammarAccess.getTJRequiredMethodAccess().getGroup_3_1(), "rule__TJRequiredMethod__Group_3_1__0");
					...
					put(grammarAccess.getTJProgramAccess().getNameAssignment_0_1(), "rule__TJProgram__NameAssignment_0_1");
					put(grammarAccess.getTJProgramAccess().getImportSectionAssignment_1(), "rule__TJProgram__ImportSectionAssignment_1");
					put(grammarAccess.getTJProgramAccess().getElementsAssignment_2(), "rule__TJProgram__ElementsAssignment_2");
					put(grammarAccess.getTJTraitAccess().getNameAssignment_1(), "rule__TJTrait__NameAssignment_1");
					put(grammarAccess.getTJTraitAccess().getTraitExpressionAssignment_2_1(), "rule__TJTrait__TraitExpressionAssignment_2_1");
					put(grammarAccess.getTJTraitAccess().getMembersAssignment_4(), "rule__TJTrait__MembersAssignment_4");
					put(grammarAccess.getTJClassAccess().getNameAssignment_1(), "rule__TJClass__NameAssignment_1");
					put(grammarAccess.getTJClassAccess().getInterfacesAssignment_2_1(), "rule__TJClass__InterfacesAssignment_2_1");
					...
					put(grammarAccess.getTJTraitReferenceAccess().getOperationsAssignment_1_1(), "rule__TJTraitReference__OperationsAssignment_1_1");
					put(grammarAccess.getTJTraitReferenceAccess().getOperationsAssignment_1_2_1(), "rule__TJTraitReference__OperationsAssignment_1_2_1");
					put(grammarAccess.getTJHideOperationAccess().getMemberAssignment_2(), "rule__TJHideOperation__MemberAssignment_2");
					put(grammarAccess.getTJRestrictOperationAccess().getMemberAssignment_2(), "rule__TJRestrictOperation__MemberAssignment_2");
					put(grammarAccess.getTJAliasOperationAccess().getMemberAssignment_2(), "rule__TJAliasOperation__MemberAssignment_2");
					put(grammarAccess.getTJAliasOperationAccess().getNewnameAssignment_4(), "rule__TJAliasOperation__NewnameAssignment_4");
					put(grammarAccess.getTJRenameOperationAccess().getMemberAssignment_2(), "rule__TJRenameOperation__MemberAssignment_2");
					put(grammarAccess.getTJRenameOperationAccess().getNewnameAssignment_4(), "rule__TJRenameOperation__NewnameAssignment_4");
					put(grammarAccess.getTJRedirectOperationAccess().getMemberAssignment_2(), "rule__TJRedirectOperation__MemberAssignment_2");
					put(grammarAccess.getTJRedirectOperationAccess().getMember2Assignment_4(), "rule__TJRedirectOperation__Member2Assignment_4");
					put(grammarAccess.getTJFieldAccess().getTypeAssignment_0(), "rule__TJField__TypeAssignment_0");
					put(grammarAccess.getTJFieldAccess().getNameAssignment_1(), "rule__TJField__NameAssignment_1");
					put(grammarAccess.getTJFieldAccess().getInitAssignment_2_1(), "rule__TJField__InitAssignment_2_1");
					put(grammarAccess.getTJRequiredMethodAccess().getTypeAssignment_0(), "rule__TJRequiredMethod__TypeAssignment_0");
					put(grammarAccess.getTJRequiredMethodAccess().getNameAssignment_1(), "rule__TJRequiredMethod__NameAssignment_1");
					put(grammarAccess.getTJRequiredMethodAccess().getParamsAssignment_3_0(), "rule__TJRequiredMethod__ParamsAssignment_3_0");
					put(grammarAccess.getTJRequiredMethodAccess().getParamsAssignment_3_1_1(), "rule__TJRequiredMethod__ParamsAssignment_3_1_1");
					put(grammarAccess.getTJMethodAccess().getPrivateAssignment_0(), "rule__TJMethod__PrivateAssignment_0");
					put(grammarAccess.getTJMethodAccess().getTypeAssignment_1(), "rule__TJMethod__TypeAssignment_1");
					put(grammarAccess.getTJMethodAccess().getNameAssignment_2(), "rule__TJMethod__NameAssignment_2");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			xtraitj.ui.contentassist.antlr.internal.InternalXtraitjParser typedParser = (xtraitj.ui.contentassist.antlr.internal.InternalXtraitjParser) parser;
			typedParser.entryRuleTJProgram();
